const _domainName = 'shokhlive.com';
const kDomain = 'https://shokhlive.com';
...
String kWebSocketLiveStreamingUrl(roomName) {
  print(roomName);
  print('wss://shokhlive.com/ws/live-streaming/$roomName/');
  return 'wss://shokhlive.com/ws/live-streaming/$roomName/';
}
